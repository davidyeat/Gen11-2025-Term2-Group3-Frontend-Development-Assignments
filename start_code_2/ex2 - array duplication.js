...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "Johny", batch: 1, age: 20 },
  { firstName: "Bình", lastName: "Nguyen", batch: 2, age: 22 },
  { firstName: "Cẩm", lastName: "Tran", batch: 1, age: 21 },
  { firstName: "An", lastName: "Smith", batch: 2, age: 19 }, // Duplicate first name !
];
...
updateStudentAge("An", "Smith", 2, 30);
